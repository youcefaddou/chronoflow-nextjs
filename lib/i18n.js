    ...
    resources: {
      fr: {
        translation: {
          ...
          "header.resources": "Ressources",          "header.dashboard": "Tableau de bord",
          ...
          "footer.terms": "Conditions d'utilisation",          "footer.rights": "Tous droits réservés.",          // Authentication
          ...
          "auth.signup.signIn": "Se connecter",          "auth.login.title": "Connexion",
          ...
          "auth.login.signing": "Connexion...",
          "auth.login.signIn": "Se connecter",
          "auth.login.googleSignIn": "Se connecter avec Google",          "auth.login.noAccount": "Pas encore de compte ?",
          "auth.login.createAccount": "Créer un compte",
          ...
          "calendar.timesheet": "Feuille de temps",              // Dashboard          
          ...
          "task.completed": "Terminée",          // Timer actions
          "timer.start": "Démarrer",
          "timer.play": "Démarrer",
          "timer.pause": "Pause",
          "timer.resume": "Reprendre",
          ...
          settings: {
            ...
            others: 'Autres',              items: {
                ...
                language: 'Langue',                languageDesc: 'Choisissez votre langue préférée pour l\'interface',
                ...
                contactSupport: 'Contacter le support',                contactSupportDesc: 'Contactez notre équipe de support pour obtenir de l\'aide',
      ...
      en: {
        translation: {
          ...
          "header.resources": "Resources",          "header.dashboard": "Dashboard",
          "header.login": "Login",
          ...
          "footer.terms": "Terms of Service",          "footer.rights": "All rights reserved.",          // Authentication
          ...
          "auth.login.googleSignIn": "Sign in with Google",          "auth.login.noAccount": "Don't have an account?",
          ...
          "calendar.timesheet": "Timesheet",          // Dashboard
          ...
          "dashboard.getInTheZone": "Get in the zone",          "dashboard.focusMessage": "Stay focused and avoid distractions. You are in the zone!",
          ...
          "task.completed": "Completed",          // Timer actions
          "timer.start": "Start",
          "timer.play": "Play",
          "timer.pause": "Pause",
          "timer.resume": "Resume",
          ...
          settings: {
            ...
            others: 'Others',            items: {
              ...
              languageChanged: 'Language changed successfully',              languageChangeError: 'Error changing language',
              notifications: 'Notifications',
          ...
          googleCalendar: {
            ...
            connecting: 'Connecting...',          connected: 'Google Calendar connected',
          },
          // Visual preview section
